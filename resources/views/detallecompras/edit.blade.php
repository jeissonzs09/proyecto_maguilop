<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto mt-6 bg-white p-6 rounded shadow">
        <form action="{{ route('detallecompras.update', $detalle->DetalleCompraID) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="CompraID" id="CompraID" class="w-full border rounded px-3 py-2" required>
                    ...
                    @foreach ($compras as $compra)
                        <option value="{{ $compra->CompraID }}" {{ old('CompraID', $detalle->CompraID) == $compra->CompraID ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <select name="ProductoID" id="ProductoID" class="w-full border rounded px-3 py-2" required>
                    ...
                    @foreach ($productos as $producto)
                        <option value="{{ $producto->ProductoID }}" {{ old('ProductoID', $detalle->ProductoID) == $producto->ProductoID ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="Cantidad" id="Cantidad" value="{{ old('Cantidad', $detalle->Cantidad) }}" min="1"
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" name="PrecioUnitario" id="PrecioUnitario" value="{{ old('PrecioUnitario', $detalle->PrecioUnitario) }}" min="0"
                    class="w-full border rounded px-3 py-2" required oninput="calculateSubtotal()">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" name="Subtotal" id="Subtotal" value="{{ old('Subtotal', $detalle->Subtotal) }}"
    ...
    <script>
        ...
        // Ejecutar al cargar la página para que el subtotal esté correcto si hay valores
